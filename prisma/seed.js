...
async function main() {
  ...
  const pages = [
    ...
    },
    {
      ...
      metaDescription:
        "Asset stewardship and operations & maintenance services.",
      isStatic: true,
      visibility: "public",
    },
    {
      ...
      await prisma.section.create({
        data: {
          ...
          content: {
            ...
            heroSubtitle:
              "Meet the executive team guiding Encotec's engineering and project management operations",
      ...
      await prisma.section.create({
        data: {
          ...
          content: {
            ...
            heroSubtitle:
              "Stay updated with our latest project features, white papers, and corporate achievements",
            backgroundImage:
              "https://images.unsplash.com/photo-1497435334941-8c899a9bd6a2?auto=format&fit=crop&q=80&w=2400",
          },
        },
        ...
        data: {
          ...
          content: {
            ...
            latestArticleSummary:
              "A comprehensive look at our recent initiatives in supporting utility-scale solar integration.",
      ...
      await prisma.section.create({
        data: {
          ...
          content: {
            ...
            heroSubtitle:
              "Shape the future of energy and infrastructure engineering with our exceptional team",
            backgroundImage:
      ...
      await prisma.section.create({
        data: {
          ...
          content: {
            ...
            heroSubtitle:
              "We hold ourselves to the highest standards of safety, quality, and environmental responsibility",
            backgroundImage:
