    ...
    <section className=" flex flex-col gap-6">
      <header className=" flex justify-between items-center w-full">
        <h1 className="text-[28px] font-bold tracking-tight text-[#0B0F29] flex items-center gap-2">
          Welcome back <span className="text-[#a0004f]">{userName}</span>
      ...
      <div className="flex justify-between items-center relative">
        <div className="relative group w-[350px]" ref={searchRef}>
          ...
          <input
            ...
            className="pl-10 pr-10 py-3.5 bg-white border-0 ring-1 ring-gray-100 w-full rounded-full text-sm font-medium focus:ring-2 focus:ring-[#a0004f] focus:outline-none shadow-sm transition-all"
          />
          {searchQuery && (
            <button
              onClick={() => {
              ...
              {results.length === 0 ? (
                ...
                <div className="flex flex-col">
                  {results.map((item, idx) => (
                    ...
                    >
                      <div className="p-2 rounded-xl bg-pink-50 text-[#a0004f]">
