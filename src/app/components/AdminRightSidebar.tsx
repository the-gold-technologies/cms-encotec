  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="bg-[#0B0F29] rounded-[2rem] p-7 text-white relative overflow-hidden shadow-xl">
        ...
        <div className="absolute bottom-0 left-0 w-24 h-24 bg-[#a0004f]/10 rounded-full blur-xl translate-y-1/2 -translate-x-1/2"></div>
        ...
        <Link
          href="/seo/global"
          className="inline-block bg-[#a0004f] text-white px-6 py-2.5 rounded-full text-sm font-bold hover:bg-white hover:text-[#a0004f] transition-colors transform hover:scale-105 shadow-[0_0_20px_rgba(217,249,105,0.3)] relative z-10"
        >
          Get Access
        </Link>
      ...
      <div>
        ...
        {loading ? (
          <div className="bg-white rounded-3xl p-6 flex justify-center items-center ring-1 ring-gray-50">
            <Loader2 className="w-5 h-5 animate-spin text-[#a0004f]" />
          </div>
        ) : activities.length === 0 ? (
