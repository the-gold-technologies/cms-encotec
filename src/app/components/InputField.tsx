...
export const InputField: React.FC<InputFieldProps> = ({
  ...
  const inputClass = `w-full ${icon ? "pl-12" : "px-6"} py-4 bg-white border border-gray-200 rounded-2xl text-sm focus:ring-2 focus:outline-none focus:border-[#a0004f] focus:ring-1 focus:ring-[#a0004f] outline-none transition-all text-gray-800 ${className}`;
