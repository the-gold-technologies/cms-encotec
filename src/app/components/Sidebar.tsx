          ...
          {sidebarLinks.map((item, index) => {
                        ...
                        return (
                          <Link
                            ...
                            className={cn(
                              ...
                              isSubActive
                                ? "bg-[#a0004f] text-white shadow-sm shadow-[#a0004f]/20 transform scale-[1.02]"
            ...
            return (
              ...
              >
                ...
                {item.badge && (
                  <div className="flex items-center justify-center w-5 h-5 rounded-full bg-[#a0004f]/80 text-white text-[10px] font-bold">
                    {item.badge}
                  </div>
                )}
              </Link>
