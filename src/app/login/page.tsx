      ...
      <div className="w-full max-w-md p-8 bg-white rounded-3xl shadow-xl border border-gray-100">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full py-4 bg-[#a0004f] text-white rounded-2xl font-bold uppercase tracking-widest hover:bg-[#0B0F29] transition-all shadow-lg shadow-[#a0004f]/20 disabled:opacity-50"
          >
        ...
        <div className="mt-8 text-center">
          <p className="text-gray-400 text-xs">
            &copy; {new Date().getFullYear()} Encotec. All rights reserved.
          </p>
        </div>
      </div>
    </div>
