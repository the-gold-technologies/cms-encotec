      ...
      accessorKey: (row: SocialItem) => (
        row.url ? (
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex items-center gap-1.5 text-[#a0004f] hover:underline font-mono text-xs"
          >
            ...
            <form onSubmit={handleSubmit} className="p-6 flex flex-col gap-4">
              <div className="space-y-1.5 flex flex-col">
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#a0004f] focus:border-transparent outline-none transition-all text-sm"
                />
              </div>
