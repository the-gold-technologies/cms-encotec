...
export default function PageSEODashboard() {
  ...
  return (
    <div className="flex flex-col gap-6 max-w-6xl mx-auto pb-20 animate-in fade-in duration-500">
      ...
      <div className="bg-white p-4 rounded-3xl border border-gray-50 shadow-sm flex items-center gap-4 px-6 focus-within:ring-2 focus-within:ring-[#a0004f]/20 transition-all">
              ...
              {isLoading ? (
                <tr>
                  <td colSpan={6} className="py-20 text-center">
                    <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-[#a0004f] mx-auto"></div>
                  </td>
                </tr>
              ) : rootLinks.length === 0 ? (
                <tr>
                            ...
                            {root.type !== "Dropdown" && (
                              <>
                                <Link
                                  ...
                                  className="p-2 bg-gray-50 text-brand-navy rounded-xl hover:bg-[#a0004f] hover:text-[#0B0F29] transition-all group"
                                  title="Edit SEO"
                                >
                              ...
                              <td className="px-6 py-4">
                                <div className="flex items-center gap-3 justify-end">
                                  <Link
                                    ...
                                    className="p-1.5 bg-white border border-gray-100 text-gray-400 rounded-lg hover:border-[#a0004f] hover:text-[#a0004f] transition-all"
                                  >
