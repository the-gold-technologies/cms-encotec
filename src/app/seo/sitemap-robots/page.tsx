...
export default function SitemapRobotsPage() {
  ...
  const websiteUrl = process.env.NEXT_PUBLIC_WEBSITE_URL || "http://localhost:5173";
  const apiBaseUrl = process.env.NEXT_PUBLIC_CMS_API_URL || "http://localhost:3000";
        ...
        <div className="bg-white rounded-3xl p-6 border border-gray-100 shadow-sm flex flex-col gap-4">
          ...
          <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
            ...
            <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto mt-2 md:mt-0">
              <a
                href={`${apiBaseUrl}/api/seo/sitemap`}
                target="_blank"
                rel="noreferrer"
              ...
              >
                ...
                <ExternalLink className="w-3.5 h-3.5 text-gray-400 group-hover:text-[#a0004f] transition-colors" />
              </a>

              <a
                href={`${apiBaseUrl}/api/seo/robots`}
                target="_blank"
                rel="noreferrer"
                className="flex items-center justify-between gap-3 p-3.5 bg-gray-50 hover:bg-gray-100 border border-gray-100 rounded-2xl text-xs font-bold text-gray-700 transition-all group w-full sm:w-auto"
              >
        ...
        <div className="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-4">
            <h3 className="text-lg font-bold text-gray-900 flex items-center gap-2">
              <Globe className="w-5 h-5 text-[#a0004f]" />
              Sitemap Options
            </h3>
            ...
            <div className="flex items-center justify-between p-4 bg-gray-50 border border-gray-100 rounded-2xl mt-2">
              <div className="flex flex-col gap-1 pr-4">
                ...
                <span className="text-[10px] text-gray-400 font-light">Automatically compiles static links and published pages into a sitemap format.</span>
              </div>
          ...
          <div className="flex flex-col gap-4">
            <div className="flex items-center justify-between flex-wrap gap-4">
              <h3 className="text-lg font-bold text-gray-900 flex items-center gap-2">
                <FileText className="w-5 h-5 text-[#a0004f]" />
                Robots.txt Rules
              </h3>
            ...
            <div className="flex flex-col gap-2">
              ...
              <textarea
                ...
                rows={8}
                className="w-full font-mono text-xs p-4 bg-gray-50 text-gray-800 border border-gray-200 focus:border-[#a0004f] focus:bg-white transition-all rounded-2xl outline-none"
              />
            </div>
          </div>
