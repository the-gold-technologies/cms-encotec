...
export function FeaturedInsightCMS() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (json.success) {
        toast.success("Featured Article Section saved successfully!", { id: toastId });
      } else {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 flex flex-col gap-4">
      <SectionHeader
        ...
        description="Manage the highlights, summary, and date details of the top featured article."
        isOpen={isOpen}
